...
bool set_val(apc_nozel::actuator_frame2::Request &req, apc_nozel::actuator_frame2::Response &res)
{
    ...
    listener.waitForTransform( "suction2", "world", ros::Time(0), ros::Duration(3));

    listener.transformPoint("suction2", centroid_point_wrt_world, centroid_point_wrt_suction_point);
    ...
    listener.transformPoint("suction2", normal_point_wrt_world, normal_point_wrt_suction_point);
