...
public:
    ...
    bool checkClearProtectiveStopCallback(apc_nozel::CheckClearProtectiveStop::Request &req,
                                          apc_nozel::CheckClearProtectiveStop::Response &res,
                                          ros::ServiceClient &client_check_ps)
    {
    //    UrCommunication ur_comm("192.168.2.200");
        apc_nozel::CheckClearProtectiveStop check_ps;
...
//    ros::param::get("/ARC17_ROBOT_IP", host);

//    std::cout<<"\n robot_ip from rosparam :"<<host<<"\n";
//        UrCommunication ur_comm("0.0.0.0");

    UrCommunication ur_comm("192.168.2.220");

    ros::ServiceClient client_check_protective_stop =
            nh.serviceClient<apc_nozel::CheckClearProtectiveStop>("/iitktcs/ur_modern_driver/check_protective_stop");

    ros::ServiceServer service_check_clear_protective_stop =
            nh.advertiseService<apc_nozel::CheckClearProtectiveStop::Request, apc_nozel::CheckClearProtectiveStop::Response>
